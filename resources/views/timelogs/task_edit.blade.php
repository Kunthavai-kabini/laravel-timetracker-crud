<form id="editTaskForm" method="POST"> 
                                               @csrf
                                               <input type="hidden" name="id" id="id" value="{{ $task_data['id'] }}">
...
@endphp
                                    <input type="date" class="form-control " id="task_added_on" name="task_added_on" value="{{ $dateValue  }}" readonly required>
                                    <span class="text-danger error" id="error-task_added_on"></span>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="edit-name" class="form-label">Task Description</label>
                                    <textarea class="form-control" id="task_description" name="task_description" required>{{$task_data['task_description']}}</textarea>
                                    <span class="text-danger error" id="error-task_description"></span>
                                </div>
                                <div class="mb-3">
                                    <label for="start_time" class="form-label">Hours</label>
                                    <input type="number" name="hours" class="form-control" value="{{$task_data['hours']}}" required>
                                    <span class="text-danger error" id="error-hours"></span>
                                </div>
                                <div class="mb-3">
                                    <label for="end_time" class="form-label">Minutes</label>
                                    <input type="number" name="minutes" class="form-control" value="{{$task_data['minutes']}}" required>
